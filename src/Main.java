...
public class Main {
	...
	private static void fillPossibilities(ArrayList<Pokemon> pokedex) {
		...
		pokedex.add(new Pokemon("Eevee", "Normal", null, 55, 55, 50, 45, 65, 55, 27, new String[] {"Field"}, 87.5, new String[] {"Eevee", "Vaporeon", "Jolteon", "Flareon", "Espeon", "Umbreon", "Leafeon", "Glaceon", "Sylveon"}, 0, -1));
		...
		pokedex.add(new Pokemon("DeoxysN", "Psychic", null, 50, 150, 50, 150, 50, 150, 32, new String[] {"Undiscovered"}, -1, new String[] {"DeoxysN"}, 0, 0)); // 385:386
		pokedex.add(new Pokemon("DeoxysA", "Psychic", null, 50, 180, 20, 180, 20, 150, 32, new String[] {"Undiscovered"}, -1, new String[] {"DeoxysA"}, 0, 0)); // 386:386
		pokedex.add(new Pokemon("DeoxysD", "Psychic", null, 50, 70, 160, 70, 160, 90, 32, new String[] {"Undiscovered"}, -1, new String[] {"DeoxysD"}, 0, 0)); // 387:386
		pokedex.add(new Pokemon("DeoxysS", "Psychic", null, 50, 95, 90, 95, 90, 180, 32, new String[] {"Undiscovered"}, -1, new String[] {"DeoxysS"}, 0, 0)); // 388:386
		...
		pokedex.add(new Pokemon("WormadamP", "Bug", "Grass", 60, 59, 85, 79, 105, 36, 27, new String[] {"Bug"}, 0, new String[] {"Burmy", "WormadamP"}, 1, 0)); // 415:413
		pokedex.add(new Pokemon("WormadamS", "Bug", "Ground", 60, 79, 105, 59, 85, 36, 27, new String[] {"Bug"}, 0, new String[] {"Burmy", "WormadamS"}, 1, 0)); // 416:413
		pokedex.add(new Pokemon("WormadamT", "Bug", "Steel", 60, 69, 95, 69, 95, 36, 27, new String[] {"Bug"}, 0, new String[] {"Burmy", "WormadamT"}, 1, 0)); // 417:413
		pokedex.add(new Pokemon("Mothim", "Bug", "Flying", 70, 94, 50, 94, 50, 66, 27, new String[] {"Bug"}, 100, new String[] {"Burmy", "Mothim"}, 1, 0));
		...
		pokedex.add(new Pokemon("Trubbish", "Poison", null, 50, 50, 62, 40, 62, 65, 6, new String[] {"Mineral"}, 50, new String[] {"Trubbish", "Garbodor"}, 0, 36));
		pokedex.add(new Pokemon("Garbodor", "Poison", null, 80, 95, 82, 60, 82, 75, 24, new String[] {"Mineral"}, 50, new String[] {"Trubbish", "Garbodor"}, 1, 0));
		pokedex.add(new Pokemon("Zorua", "Dark", null, 40, 65, 40, 80, 40, 65, 21, new String[] {"Field"}	, 87.5, new String[] {"Zorua", "Zoroark"}, 0, 30));
		pokedex.add(new Pokemon("Zoroark", "Dark", null, 60, 105, 60, 120, 60, 105, 27, new String[] {"Field"}, 87.5, new String[] {"Zorua", "Zoroark"}, 1, 0));
		pokedex.add(new Pokemon("Minccino", "Normal", null, 55, 50, 40, 40, 40, 75, 0, new String[] {"Field"}, 25, new String[] {"Minccino", "Cinccino"}, 0, -1));
		pokedex.add(new Pokemon("Cinccino", "Normal", null, 75, 95, 60, 65, 60, 115, 24, new String[] {"Field"}, 25, new String[] {"Minccino", "Cinccino"}, 1, 0));
		pokedex.add(new Pokemon("Gothita", "Psychic", null, 45, 30, 50, 55, 65, 45, 5, new String[] {"Human-Like"}, 25, new String[] {"Gothita", "Gothorita", "Gothitelle"}, 0, 32));
		pokedex.add(new Pokemon("Gothorita", "Psychic", null, 60, 45, 70, 75, 85, 55, 18, new String[] {"Human-Like"}, 25, new String[] {"Gothita", "Gothorita", "Gothitelle"}, 1, 41));
		pokedex.add(new Pokemon("Gothitelle", "Psychic", null, 70, 55, 95, 95, 110, 95, 26, new String[] {"Human-Like"}, 25, new String[] {"Gothita", "Gothorita", "Gothitelle"}, 2, 0));
		pokedex.add(new Pokemon("Solosis", "Psychic", null, 45, 30, 45, 105, 50, 20, 5, new String[] {"Amorphous"}, 50, new String[] {"Solosis", "Duosion", "Reuniclus"}, 0, 32));
		pokedex.add(new Pokemon("Duosion", "Psychic", null, 65, 40, 50, 125, 60, 30, 18, new String[] {"Amorphous"}, 50, new String[] {"Solosis", "Duosion", "Reuniclus"}, 1, 41));
		pokedex.add(new Pokemon("Reuniclus", "Psychic", null, 110, 65, 75, 125, 85, 30, 26, new String[] {"Amorphous"}, 50, new String[] {"Solosis", "Duosion", "Reuniclus"}, 2, 0));
		pokedex.add(new Pokemon("Ducklett", "Water", "Flying", 62, 44, 50, 44, 50, 55, 6, new String[] {"Water 1", "Flying"}, 50, new String[] {"Ducklett", "Swanna"}, 0, 35));
		pokedex.add(new Pokemon("Swanna", "Water", "Flying", 75, 87, 63, 87, 63, 98, 27, new String[] {"Water 1", "Flying"}, 50, new String[] {"Ducklett", "Swanna"}, 1, 0));
		pokedex.add(new Pokemon("Vanillite", "Ice", null, 36, 50, 50, 65, 60, 44, 0, new String[] {"Mineral"}, 50, new String[] {"Vanillite", "Vanillish", "Vanilluxe"}, 0, 35));
		pokedex.add(new Pokemon("Vanillish", "Ice", null, 51, 65, 65, 80, 75, 59, 17, new String[] {"Mineral"}, 50, new String[] {"Vanillite", "Vanillish", "Vanilluxe"}, 1, 47));
		pokedex.add(new Pokemon("Vanilluxe", "Ice", null, 71, 95, 85, 110, 95, 79, 27, new String[] {"Mineral"}, 50, new String[] {"Vanillite", "Vanillish", "Vanilluxe"}, 2, 0));
		pokedex.add(new Pokemon("Deerling", "Normal", "Grass", 60, 60, 50, 40, 50, 75, 6, new String[] {"Field"}, 50, new String[] {"Deerling", "Sawsbuck"}, 0, 34));
		pokedex.add(new Pokemon("Sawsbuck", "Normal", "Grass", 80, 100, 70, 60, 70, 95, 21, new String[] {"Field"}, 50, new String[] {"Deerling", "Sawsbuck"}, 1, 0));
		pokedex.add(new Pokemon("Emolga", "Electric", "Flying", 55, 75, 60, 75, 60, 103, 5, new String[] {"Field"}, 50, new String[] {"Emolga"}, 0, 0));
		pokedex.add(new Pokemon("Karrablast", "Bug", null, 50, 75, 45, 40, 45, 60, 5, new String[] {"Bug"}, 50, new String[] {"Karrablast", "Escavalier"}, 0, -1));
		pokedex.add(new Pokemon("Escavalier", "Bug", "Steel", 70, 135, 105, 60, 105, 20, 21, new String[] {"Bug"}, 50, new String[] {"Karrablast", "Escavalier"}, 1, 0));
		pokedex.add(new Pokemon("Foongus", "Grass", "Poison", 69, 55, 45, 55, 55, 15, 6, new String[] {"Grass"}, 50, new String[] {"Foongus", "Amoonguss"}, 0, 39));
		pokedex.add(new Pokemon("Amoonguss", "Grass", "Poison", 114, 85, 70, 85, 80, 30, 21, new String[] {"Grass"}, 50, new String[] {"Foongus", "Amoonguss"}, 1, 0));
		pokedex.add(new Pokemon("Frillish", "Water", "Ghost", 55, 40, 50, 65, 85, 40, 6, new String[] {"Amorphous"}, 50, new String[] {"Frillish", "Jellicent"}, 0, 40));
		pokedex.add(new Pokemon("Jellicent", "Water", "Ghost", 100, 60, 70, 85, 105, 60, 24, new String[] {"Amorphous"}, 50, new String[] {"Frillish", "Jellicent"}, 1, 0));
		pokedex.add(new Pokemon("Alomomola", "Water", null, 165, 75, 80, 40, 45, 65, 21, new String[] {"Water 1", "Water 2"}, 50, new String[] {"Alomomola"}, 0, 0));
		pokedex.add(new Pokemon("Joltik", "Bug", "Electric", 50, 47, 50, 57, 50, 65, 6, new String[] {"Bug"}, 50, new String[] {"Joltik", "Galvantula"}, 0, 36));
		pokedex.add(new Pokemon("Galvantula", "Bug", "Electric", 70, 77, 60, 97, 60, 108, 21, new String[] {"Bug"}, 50, new String[] {"Joltik", "Galvantula"}, 1, 0));
		pokedex.add(new Pokemon("Ferroseed", "Grass", "Steel", 44, 50, 91, 24, 86, 10, 0, new String[] {"Grass", "Mineral"}, 50, new String[] {"Ferroseed", "Ferrothorn"}, 0, 40));
		pokedex.add(new Pokemon("Ferrothorn", "Grass", "Steel", 74, 94, 131, 54, 116, 20, 19, new String[] {"Grass", "Mineral"}, 50, new String[] {"Ferroseed", "Ferrothorn"}, 1, 0));
		pokedex.add(new Pokemon("Klink", "Steel", null, 40, 55, 70, 45, 60, 30, 14, new String[] {"Mineral"}, -1, new String[] {"Klink", "Klang", "Klinklang"}, 0, 38));
		pokedex.add(new Pokemon("Klang", "Steel", null, 60, 80, 95, 70, 85, 50, 24, new String[] {"Mineral"}, -1, new String[] {"Klink", "Klang", "Klinklang"}, 1, 49));
		pokedex.add(new Pokemon("Klinklang", "Steel", null, 60, 100, 115, 70, 85, 90, 29, new String[] {"Mineral"}, -1, new String[] {"Klink", "Klang", "Klinklang"}, 2, 0));
		pokedex.add(new Pokemon("Tynamo", "Electric", null, 35, 55, 40, 45, 40, 60, 6, new String[] {"Amorphous"}, 50, new String[] {"Tynamo", "Eelektrik", "Eelektross"}, 0, 39));
		pokedex.add(new Pokemon("Eelektrik", "Electric", null, 65, 85, 70, 75, 70, 40, 24, new String[] {"Amorphous"}, 50, new String[] {"Tynamo", "Eelektrik", "Eelektross"}, 1, -1));
		pokedex.add(new Pokemon("Eelektross", "Electric", null, 85, 115, 80, 105, 80, 50, 29, new String[] {"Amorphous"}, 50, new String[] {"Tynamo", "Eelektrik", "Eelektross"}, 2, 0));
		pokedex.add(new Pokemon("Elgyem", "Psychic", null, 55, 55, 55, 85, 55, 30, 0, new String[] {"Human-Like"}, 50, new String[] {"Elgyem", "Beheeyem"}, 0, 42));
		pokedex.add(new Pokemon("Beheeyem", "Psychic", null, 75, 75, 75, 125, 95, 40, 19, new String[] {"Human-Like"}, 50, new String[] {"Elgyem", "Beheeyem"}, 1, 0));
		pokedex.add(new Pokemon("Litwick", "Ghost", "Fire", 50, 30, 55, 65, 55, 20, 6, new String[] {"Amorphous"}, 50, new String[] {"Litwick", "Lampent", "Chandelure"}, 0, 41));
		pokedex.add(new Pokemon("Lampent", "Ghost", "Fire", 60, 40, 60, 95, 60, 55, 19, new String[] {"Amorphous"}, 50, new String[] {"Litwick", "Lampent", "Chandelure"}, 1, -1));
		pokedex.add(new Pokemon("Chandelure", "Ghost", "Fire", 60, 55, 90, 145, 90, 80, 27, new String[] {"Amorphous"}, 50, new String[] {"Litwick", "Lampent", "Chandelure"}, 2, 0));
		pokedex.add(new Pokemon("Axew", "Dragon", null, 46, 87, 60, 30, 40, 57, 21, new String[] {"Monster", "Dragon"}, 50, new String[] {"Axew", "Fraxure", "Haxorus"}, 0, 38));
		pokedex.add(new Pokemon("Fraxure", "Dragon", null, 66, 117, 70, 40, 50, 67, 24, new String[] {"Monster", "Dragon"}, 50, new String[] {"Axew", "Fraxure", "Haxorus"}, 1, 48));
		pokedex.add(new Pokemon("Haxorus", "Dragon", null, 76, 147, 90, 60, 70, 97, 27, new String[] {"Monster", "Dragon"}, 50, new String[] {"Axew", "Fraxure", "Haxorus"}, 2, 0));
		pokedex.add(new Pokemon("Cubchoo", "Ice", null, 55, 70, 40, 60, 40, 40, 17, new String[] {"Field"}, 50, new String[] {"Cubchoo", "Beartic"}, 0, 37));
		pokedex.add(new Pokemon("Beartic", "Ice", null, 95, 103, 80, 70, 80, 50, 24, new String[] {"Field"}, 50, new String[] {"Cubchoo", "Beartic"}, 1, 0));
		pokedex.add(new Pokemon("Cryogonal", "Ice", null, 80, 50, 50, 95, 135, 105, 30, new String[] {"Mineral"}, -1, new String[] {"Cryogonal"}, 0, 0));
		pokedex.add(new Pokemon("Shelmet", "Bug", null, 50, 40, 85, 40, 65, 25, 5, new String[] {"Bug"}, 50, new String[] {"Shelmet", "Accelgor"}, 0, -1));
		pokedex.add(new Pokemon("Accelgor", "Bug", null, 80, 70, 40, 100, 60, 145, 21, new String[] {"Bug"}, 50, new String[] {"Shelmet", "Accelgor"}, 1, 0));
		pokedex.add(new Pokemon("Stunfisk", "Ground", "Electric", 109, 66, 84, 81, 99, 32, 21, new String[] {"Water 1", "Amorphous"}, 50, new String[] {"Stunfisk"}, 0, 0));
		pokedex.add(new Pokemon("Mienfoo", "Fighting", null, 45, 85, 50, 55, 50, 65, 7, new String[] {"Field", "Human-Like"}, 50, new String[] {"Mienfoo", "Mienshao"}, 0, 50));
		pokedex.add(new Pokemon("Mienshao", "Fighting", null, 65, 125, 60, 95, 60, 105, 27, new String[] {"Field", "Human-Like"}, 50, new String[] {"Mienfoo", "Mienshao"}, 1, 0));
		pokedex.add(new Pokemon("Druddigon", "Dragon", null, 77, 120, 90, 60, 90, 48, 27, new String[] {"Dragon", "Monster"}, 50, new String[] {"Druddigon"}, 0, 0));
		pokedex.add(new Pokemon("Golett", "Ground", "Ghost", 59, 74, 50, 35, 50, 35, 6, new String[] {"Mineral"}, -1, new String[] {"Golett", "Golurk"}, 0, 43));
		pokedex.add(new Pokemon("Golurk", "Ground", "Ghost", 89, 124, 80, 55, 80, 55, 19, new String[] {"Mineral"}, -1, new String[] {"Golett", "Golurk"}, 1, 0));
		pokedex.add(new Pokemon("Pawniard", "Dark", "Steel", 45, 85, 70, 40, 40, 60, 17, new String[] {"Human-Like"}, 50, new String[] {"Pawniard", "Bisharp"}, 0, 52));
		pokedex.add(new Pokemon("Bisharp", "Dark", "Steel", 65, 125, 100, 60, 70, 70, 27, new String[] {"Human-Like"}, 50, new String[] {"Pawniard", "Bisharp"}, 1, 0));
		pokedex.add(new Pokemon("Bouffalant", "Normal", null, 95, 110, 95, 40, 95, 55, 27, new String[] {"Field"}, 50, new String[] {"Bouffalant"}, 0, 0));
		pokedex.add(new Pokemon("Rufflet", "Normal", "Flying", 70, 83, 50, 37, 50, 60, 6, new String[] {"Flying"}, 100, new String[] {"Rufflet", "Braviary"}, 0, 54));
		pokedex.add(new Pokemon("Braviary", "Normal", "Flying", 100, 123, 75, 57, 75, 80, 24, new String[] {"Flying"}, 100, new String[] {"Rufflet", "Braviary"}, 1, 0));
		pokedex.add(new Pokemon("Vullaby", "Dark", "Flying", 70, 55, 75, 45, 65, 60, 6, new String[] {"Flying"}, 0, new String[] {"Vullaby", "Mandibuzz"}, 0, 54));
		pokedex.add(new Pokemon("Mandibuzz", "Dark", "Flying", 110, 65, 105, 55, 95, 80, 24, new String[] {"Flying"}, 0, new String[] {"Vullaby", "Mandibuzz"}, 1, 0));
		pokedex.add(new Pokemon("Heatmor", "Fire", null, 85, 97, 66, 105, 66, 65, 19, new String[] {"Field"}, 50, new String[] {"Heatmor"}, 0, 0));
		pokedex.add(new Pokemon("Durant", "Bug", "Steel", 58, 109, 112, 48, 48, 109, 19, new String[] {"Bug"}, 50, new String[] {"Durant"}, 0, 0));
		pokedex.add(new Pokemon("Deino", "Dark", "Dragon", 52, 65, 50, 45, 50, 38, 27, new String[] {"Dragon"}, 50, new String[] {"Deino", "Zweilous", "Hydreigon"}, 0, 50));
		pokedex.add(new Pokemon("Zweilous", "Dark", "Dragon", 72, 85, 70, 65, 70, 58, 27, new String[] {"Dragon"}, 50, new String[] {"Deino", "Zweilous", "Hydreigon"}, 1, 64));
		pokedex.add(new Pokemon("Hydreigon", "Dark", "Dragon", 92, 105, 90, 125, 90, 98, 27, new String[] {"Dragon"}, 50, new String[] {"Deino", "Zweilous", "Hydreigon"}, 2, 0));
		pokedex.add(new Pokemon("Larvesta", "Bug", "Fire", 55, 85, 55, 50, 55, 60, 27, new String[] {"Bug"}, 50, new String[] {"Larvesta", "Volcarona"}, 0, 59));
		pokedex.add(new Pokemon("Volcarona", "Bug", "Fire", 85, 60, 65, 135, 105, 100, 31, new String[] {"Bug"}, 50, new String[] {"Larvesta", "Volcarona"}, 1, 0));
		pokedex.add(new Pokemon("Cobalion", "Steel", "Fighting", 91, 90, 129, 90, 72, 108, 32, new String[] {"Undiscovered"}, -1, new String[] {"Cobalion"}, 0, 0));
		pokedex.add(new Pokemon("Terrakion", "Rock", "Fighting", 91, 129, 90, 72, 90, 108, 32, new String[] {"Undiscovered"}, -1, new String[] {"Terrakion"}, 0, 0));
		pokedex.add(new Pokemon("Virizion", "Grass", "Fighting", 91, 90, 72, 90, 129, 108, 32, new String[] {"Undiscovered"}, -1, new String[] {"Virizion"}, 0, 0));
		pokedex.add(new Pokemon("TornadusI", "Flying", null, 79, 115, 70, 125, 80, 111, 32, new String[] {"Undiscovered"}, 100, new String[] {"TornadusI"}, 0, 0)); // 653:641
		pokedex.add(new Pokemon("TornadusT", "Flying", null, 79, 100, 80, 110, 90, 121, 32, new String[] {"Undiscovered"}, 100, new String[] {"TornadusT"}, 0, 0)); // 654:641
		pokedex.add(new Pokemon("ThundurusI", "Electric", "Flying", 79, 115, 70, 125, 80, 111, 32, new String[] {"Undiscovered"}, 100, new String[] {"ThundurusI"}, 0, 0)); // 655:642
		pokedex.add(new Pokemon("ThundurusT", "Electric", "Flying", 79, 105, 70, 145, 80, 101, 32, new String[] {"Undiscovered"}, 100, new String[] {"ThundurusT"}, 0, 0)); // 656:642
		pokedex.add(new Pokemon("Reshiram", "Dragon", "Fire", 100, 120, 100, 150, 120, 90, 32, new String[] {"Undiscovered"}, -1, new String[] {"Reshiram"}, 0, 0));
		pokedex.add(new Pokemon("Zekrom", "Dragon", "Electric", 100, 150, 120, 120, 100, 90, 32, new String[] {"Undiscovered"}, -1, new String[] {"Zekrom"}, 0, 0));
		pokedex.add(new Pokemon("LandorusI", "Ground", "Flying", 89, 125, 90, 115, 80, 101, 32, new String[] {"Undiscovered"}, 100, new String[] {"LandorusI"}, 0, 0)); // 659:645
		pokedex.add(new Pokemon("LandorusT", "Ground", "Flying", 89, 145, 90, 105, 80, 91, 32, new String[] {"Undiscovered"}, 100, new String[] {"LandorusT"}, 0, 0)); // 660:645
		pokedex.add(new Pokemon("Kyurem", "Dragon", "Ice", 125, 130, 90, 130, 90, 95, 32, new String[] {"Undiscovered"}, -1, new String[] {"Kyurem"}, 0, 0)); // 661:646
		pokedex.add(new Pokemon("KyuremW", "Dragon", "Ice", 125, 120, 90, 170, 100, 95, 32, new String[] {"Undiscovered"}, -1, new String[] {"KyuremW"}, 0, 0)); // 662:646
		pokedex.add(new Pokemon("KyuremB", "Dragon", "Ice", 125, 170, 100, 120, 90, 95, 32, new String[] {"Undiscovered"}, -1, new String[] {"KyuremB"}, 0, 0)); // 663:646
		pokedex.add(new Pokemon("Keldeo", "Water", "Fighting", 91, 72, 90, 129, 90, 108, 32, new String[] {"Undiscovered"}, -1, new String[] {"Keldeo"}, 0, 0));
		pokedex.add(new Pokemon("MeloettaA", "Normal", "Psychic", 100, 77, 77, 128, 128, 90, 32, new String[] {"Undiscovered"}, -1, new String[] {"MeloettaA"}, 0, 0)); // 665:648
		pokedex.add(new Pokemon("MeloettaP", "Normal", "Fighting", 100, 128, 90, 77, 77, 128, 32, new String[] {"Undiscovered"}, -1, new String[] {"MeloettaP"}, 0, 0)); // 666:648
		pokedex.add(new Pokemon("Genesect", "Bug", "Steel", 71, 120, 95, 120, 95, 99, 32, new String[] {"Undiscovered"}, -1, new String[] {"Genesect"}, 0, 0));
		pokedex.add(new Pokemon("Chespin", "Grass", null, 56, 61, 65, 48, 45, 38, 27, new String[] {"Field"}, 87.5, new String[] {"Chespin", "Quilladin", "Chestnaught"}, 0, 16));
		pokedex.add(new Pokemon("Quilladin", "Grass", null, 61, 78, 95, 56, 58, 57, 27, new String[] {"Field"}, 87.5, new String[] {"Chespin", "Quilladin", "Chestnaught"}, 1, 36));
		pokedex.add(new Pokemon("Chestnaught", "Grass", "Fighting", 88, 107, 122, 74, 75, 64, 27, new String[] {"Field"}, 87.5, new String[] {"Chespin", "Quilladin", "Chestnaught"}, 2, 0));
		pokedex.add(new Pokemon("Fennekin", "Fire", null, 40, 45, 40, 62, 60, 60, 27, new String[] {"Field"}, 87.5, new String[] {"Fennekin", "Braixen", "Delphox"}, 0, 16));
		pokedex.add(new Pokemon("Braixen", "Fire", null, 59, 59, 58, 90, 70, 73, 27, new String[] {"Field"}, 87.5, new String[] {"Fennekin", "Braixen", "Delphox"}, 1, 36));
		pokedex.add(new Pokemon("Delphox", "Fire", "Psychic", 75, 69, 72, 114, 100, 104, 27, new String[] {"Field"}, 87.5, new String[] {"Fennekin", "Braixen", "Delphox"}, 2, 0));
		pokedex.add(new Pokemon("Froakie", "Water", null, 41, 56, 40, 62, 44, 71, 27, new String[] {"Water 1"}, 87.5, new String[] {"Froakie", "Frogadier", "Greninja", "GreninjaA"}, 0, 16));
		pokedex.add(new Pokemon("Frogadier", "Water", null, 54, 63, 52, 83, 56, 97, 27, new String[] {"Water 1"}, 87.5, new String[] {"Froakie", "Frogadier", "Greninja"}, 1, 36));
		pokedex.add(new Pokemon("Greninja", "Water", "Dark", 72, 95, 67, 103, 71, 122, 27, new String[] {"Water 1"}, 87.5, new String[] {"Froakie", "Frogadier", "Greninja"}, 2, 0)); // 676:658
		pokedex.add(new Pokemon("GreninjaA", "Water", "Dark", 72, 145, 67, 153, 71, 132, 27, new String[] {"Water 1"}, 87.5, new String[] {"Froakie", "Frogadier", "GreninjaA"}, 2, 0)); // 677:658
		pokedex.add(new Pokemon("Bunnelby", "Normal", null, 38, 36, 38, 32, 36, 57, 0, new String[] {"Field"}, 50, new String[] {"Bunnelby", "Diggerby"}, 0, 20));
		pokedex.add(new Pokemon("Diggersby", "Normal", "Ground", 85, 56, 77, 50, 77, 78, 15, new String[] {"Field"}, 50, new String[] {"Bunnelby", "Diggerby"}, 1, 0));
		pokedex.add(new Pokemon("Fletchling", "Normal", "Flying", 45, 50, 43, 40, 38, 62, 0, new String[] {"Flying"}, 50, new String[] {"Fletchling", "Fletchinder", "Talonflame"}, 0, 17));
		pokedex.add(new Pokemon("Fletchinder", "Fire", "Flying", 62, 73, 55, 56, 52, 84, 17, new String[] {"Flying"}, 50, new String[] {"Fletchling", "Fletchinder", "Talonflame"}, 1, 35));
		pokedex.add(new Pokemon("Talonflame", "Fire", "Flying", 78, 81, 71, 74, 69, 126, 27, new String[] {"Flying"}, 50, new String[] {"Fletchling", "Fletchinder", "Talonflame"}, 2, 0));
		pokedex.add(new Pokemon("Scatterbug", "Bug", null, 38, 35, 40, 27, 25, 35, 0, new String[] {"Bug"}, 50, new String[] {"Scatterbug", "Spewpa", "Vivillon"}, 0, 9));
		pokedex.add(new Pokemon("Spewpa", "Bug", null, 45, 22, 60, 27, 30, 29, 17, new String[] {"Bug"}, 50, new String[] {"Scatterbug", "Spewpa", "Vivillon"}, 1, 12));
		pokedex.add(new Pokemon("Vivillon", "Bug", "Flying", 80, 52, 50, 90, 50, 89, 27, new String[] {"Bug"}, 50, new String[] {"Scatterbug", "Spewpa", "Vivillon"}, 2, 0));
		pokedex.add(new Pokemon("Litleo", "Fire", "Normal", 62, 50, 58, 73, 54, 72, 3, new String[] {"Field"}, 12.5, new String[] {"Litleo", "Pyroar"}, 0, 35));
		pokedex.add(new Pokemon("Pyroar", "Fire", "Normal", 86, 68, 72, 109, 66, 106, 23, new String[] {"Field"}, 12.5, new String[] {"Litleo", "Pyroar"}, 1, 0));
		pokedex.add(new Pokemon("Flabebe", "Fairy", null, 44, 38, 39, 61, 79, 42, 2, new String[] {"Fairy"}, 0, new String[] {"Flabebe", "Floette", "Florges"}, 0, 19));
		pokedex.add(new Pokemon("Floette", "Fairy", null, 54, 45, 47, 75, 98, 52, 17, new String[] {"Fairy"}, 0, new String[] {"Flabebe", "Floette", "Florges"}, 1, -1));
		pokedex.add(new Pokemon("Florges", "Fairy", null, 78, 65, 68, 112, 154, 75, 27, new String[] {"Fairy"}, 0, new String[] {"Flabebe", "Floette", "Florges"}, 2, 0));
		pokedex.add(new Pokemon("Skiddo", "Grass", null, 66, 65, 48, 62, 57, 52, 5, new String[] {"Field"}, 50, new String[] {"Skiddo", "Gogoat"}, 0, 32));
		pokedex.add(new Pokemon("Gogoat", "Grass", null, 123, 100, 62, 97, 81, 68, 27, new String[] {"Field"}, 50, new String[] {"Skiddo", "Gogoat"}, 1, 0));
		pokedex.add(new Pokemon("Pancham", "Fighting", null, 67, 82, 62, 46, 48, 43, 3, new String[] {"Field", "Human-Like"}, 50, new String[] {"Pancham", "Pangoro"}, 0, 32));
		pokedex.add(new Pokemon("Pangoro", "Fighting", "Dark", 95, 124, 78, 69, 71, 58, 23, new String[] {"Field", "Human-Like"}, 50, new String[] {"Pancham", "Pangoro"}, 1, 0));
		pokedex.add(new Pokemon("Furfrou", "Normal", null, 75, 80, 60, 65, 90, 102, 9, new String[] {"Field"}, 50, new String[] {"Furfrou"}, 0, 0));
		pokedex.add(new Pokemon("Espurr", "Psychic", null, 62, 48, 54, 63, 60, 68, 6, new String[] {"Field"}, 50, new String[] {"Espurr", "Meowstic"}, 0, 25));
		pokedex.add(new Pokemon("Meowstic", "Psychic", null, 74, 48, 76, 83, 81, 104, 21, new String[] {"Field"}, 50, new String[] {"Espurr", "Meowstic"}, 1, 0));
		pokedex.add(new Pokemon("Honedge", "Steel", "Ghost", 45, 80, 100, 35, 37, 28, 7, new String[] {"Mineral"}, 50, new String[] {"Honedge", "Doublade", "AegislashSh", "AegislashSw"}, 0, 35));
		pokedex.add(new Pokemon("Doublade", "Steel", "Ghost", 59, 110, 150, 45, 49, 35, 19, new String[] {"Mineral"}, 50, new String[] {"Honedge", "Doublade", "AegislashSw"}, 1, -1));
		pokedex.add(new Pokemon("AegislashSh", "Steel", "Ghost", 60, 50, 150, 50, 150, 60, 27, new String[] {"Mineral"}, 50, new String[] {"Honedge", "Doublade", "AegislashSh"}, 2, 0)); // 700:681
		pokedex.add(new Pokemon("AegislashSw", "Steel", "Ghost", 60, 150, 50, 150, 50, 60, 27, new String[] {"Mineral"}, 50, new String[] {"Honedge", "Doublade", "AegislashSw"}, 2, 0)); // 701:681
		pokedex.add(new Pokemon("Spritzee", "Fairy", null, 78, 52, 60, 63, 65, 23, 5, new String[] {"Fairy"}, 50, new String[] {"Spritzee", "Aromatisse"}, 0, -1));
		pokedex.add(new Pokemon("Aromatisse", "Fairy", null, 101, 72, 72, 99, 89, 29, 13, new String[] {"Fairy"}, 50, new String[] {"Spritzee", "Aromatisse"}, 1, 0));
		pokedex.add(new Pokemon("Swirlix", "Fairy", null, 62, 48, 66, 59, 57, 49, 5, new String[] {"Fairy"}, 50, new String[] {"Swirlix", "Slurpuff"}, 0, -1));
		pokedex.add(new Pokemon("Slurpuff", "Fairy", null, 82, 80, 86, 85, 75, 72, 13, new String[] {"Fairy"}, 50, new String[] {"Swirlix", "Slurpuff"}, 1, 0));
		pokedex.add(new Pokemon("Inkay", "Dark", "Psychic", 53, 54, 53, 37, 46, 45, 6, new String[] {"Water 1", "Water 2"}, 50, new String[] {"Inkay", "Malamar"}, 0, 30));
		pokedex.add(new Pokemon("Malamar", "Dark", "Psychic", 86, 92, 88, 68, 75, 73, 20, new String[] {"Water 1", "Water 2"}, 50, new String[] {"Inkay", "Malamar"}, 1, 0));
		pokedex.add(new Pokemon("Binacle", "Rock", "Water", 42, 52, 67, 39, 56, 50, 17, new String[] {"Water 3"}, 50, new String[] {"Binacle", "Barbaracle"}, 0, 39));
		pokedex.add(new Pokemon("Barbaracle", "Rock", "Water", 72, 105, 115, 54, 86, 68, 27, new String[] {"Water 3"}, 50, new String[] {"Binacle", "Barbaracle"}, 1, 0));
		pokedex.add(new Pokemon("Skrelp", "Poison", "Water", 50, 60, 60, 60, 60, 30, 2, new String[] {"Water 1", "Dragon"}, 50, new String[] {"Skrelp", "Dragalage"}, 0, 48));
		pokedex.add(new Pokemon("Dragalage", "Poison", "Dragon", 65, 75, 90, 97, 123, 44, 25, new String[] {"Water 1", "Dragon"}, 50, new String[] {"Skrelp", "Dragalage"}, 1, 0));
		pokedex.add(new Pokemon("Clauncher", "Water", null, 50, 53, 62, 58, 63, 44, 2, new String[] {"Water 1", "Water 3"}, 50, new String[] {"Clauncher", "Clawitzer"}, 0, 37));
		pokedex.add(new Pokemon("Clawitzer", "Water", null, 71, 73, 88, 120, 89, 59, 25, new String[] {"Water 1", "Water 3"}, 50, new String[] {"Clauncher", "Clawitzer"}, 1, 0));
		pokedex.add(new Pokemon("Helioptile", "Electric", "Normal", 44, 38, 33, 61, 43, 70, 6, new String[] {"Monster", "Dragon"}, 50, new String[] {"Helioptile", "Heliolisk"}, 0, -1));
		pokedex.add(new Pokemon("Heliolisk", "Electric", "Normal", 62, 55, 52, 109, 94, 109, 21, new String[] {"Monster", "Dragon"}, 50, new String[] {"Helioptile", "Heliolisk"}, 1, 0));
		pokedex.add(new Pokemon("Tyrunt", "Rock", "Dragon", 58, 89, 77, 45, 45, 48, 27, new String[] {"Monster", "Dragon"}, 87.5, new String[] {"Tyrunt", "Tyrantrum"}, 0, 39));
		pokedex.add(new Pokemon("Tyrantrum", "Rock", "Dragon", 82, 121, 119, 69, 59, 71, 27, new String[] {"Monster", "Dragon"}, 87.5, new String[] {"Tyrunt", "Tyrantrum"}, 1, 0));
		pokedex.add(new Pokemon("Amaura", "Rock", "Ice", 77, 59, 50, 67, 63, 46, 27, new String[] {"Monster"}, 87.5, new String[] {"Amaura", "Aurorus"}, 0, 39));
		pokedex.add(new Pokemon("Aurorus", "Rock", "Ice", 123, 77, 72, 99, 92, 58, 27, new String[] {"Monster"}, 87.5, new String[] {"Amaura", "Aurorus"}, 1, 0));
		pokedex.add(new Pokemon("Sylveon", "Fairy", null, 95, 65, 65, 110, 130, 60, 27, new String[] {"Field"}, 87.5, new String[] {"Eevee", "Sylveon"}, 1, 0));
		pokedex.add(new Pokemon("Hawlucha", "Fighting", "Flying", 78, 92, 75, 74, 63, 118, 18, new String[] {"Human-Like"}, 50, new String[] {"Hawlucha"}, 0, 0));
		pokedex.add(new Pokemon("Dedenne", "Electric", "Fairy", 67, 58, 57, 81, 67, 101, 7, new String[] {"Field", "Fairy"}, 50, new String[] {"Dedenne"}, 0, 0));
		pokedex.add(new Pokemon("Carbink", "Rock", "Fairy", 50, 50, 150, 50, 150, 50, 24, new String[] {"Fairy", "Mineral"}, -1, new String[] {"Carbink"}, 0, 0));
		pokedex.add(new Pokemon("Goomy", "Dragon", null, 45, 50, 35, 55, 75, 40, 27, new String[] {"Dragon"}, 50, new String[] {"Goomy", "Sliggoo", "Goodra"}, 0, 40));
		pokedex.add(new Pokemon("Sliggoo", "Dragon", null, 68, 75, 53, 83, 113, 60, 27, new String[] {"Dragon"}, 50, new String[] {"Goomy", "Sliggoo", "Goodra"}, 1, 50));
		pokedex.add(new Pokemon("Goodra", "Dragon", null, 90, 100, 70, 110, 150, 80, 27, new String[] {"Dragon"}, 50, new String[] {"Goomy", "Sliggoo", "Goodra"}, 2, 0));
		pokedex.add(new Pokemon("Klefki", "Steel", "Fairy", 57, 80, 91, 80, 87, 75, 21, new String[] {"Mineral"}, 50, new String[] {"Klefki"}, 0, 0));
		pokedex.add(new Pokemon("Phantump", "Ghost", "Grass", 43, 70, 48, 50, 60, 38, 17, new String[] {"Grass", "Amorphous"}, 50, new String[] {"Phantump", "Trevenant"}, 0, -1));
		pokedex.add(new Pokemon("Trevenant", "Ghost", "Grass", 85, 110, 76, 65, 82, 56, 24, new String[] {"Grass", "Amorphous"}, 50, new String[] {"Phantump", "Trevenant"}, 1, 0));
		pokedex.add(new Pokemon("PumpkabooS", "Ghost", "Grass", 44, 66, 70, 44, 55, 56, 17, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooS", "GourgeistS"}, 0, -1)); // 730:710
		pokedex.add(new Pokemon("PumpkabooA", "Ghost", "Grass", 49, 66, 70, 44, 55, 51, 17, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooA", "GourgeistA"}, 0, -1)); // 731:710
		pokedex.add(new Pokemon("PumpkabooL", "Ghost", "Grass", 54, 66, 70, 44, 55, 46, 17, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooL", "GourgeistL"}, 0, -1)); // 732:710
		pokedex.add(new Pokemon("PumpkabooSS", "Ghost", "Grass", 59, 66, 70, 44, 55, 41, 17, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooSS", "GourgeistSS"}, 0, -1)); // 733:710
		pokedex.add(new Pokemon("GourgeistS", "Ghost", "Grass", 55, 85, 122, 58, 75, 99, 24, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooS", "GourgeistS"}, 1, 0)); // 734:711
		pokedex.add(new Pokemon("GourgeistA", "Ghost", "Grass", 65, 90, 122, 58, 75, 84, 24, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooA", "GourgeistA"}, 1, 0)); // 735:711
		pokedex.add(new Pokemon("GourgeistL", "Ghost", "Grass", 75, 95, 122, 58, 75, 69, 24, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooL", "GourgeistL"}, 1, 0)); // 736:711
		pokedex.add(new Pokemon("GourgeistSS", "Ghost", "Grass", 85, 100, 122, 58, 75, 54, 24, new String[] {"Amorphous"}, 50, new String[] {"PumpkabooSS", "GourgeistSS"}, 1, 0)); // 737:711
		pokedex.add(new Pokemon("Bergmite", "Ice", null, 55, 69, 85, 32, 35, 28, 6, new String[] {"Monster"}, 50, new String[] {"Bergmite", "Avalugg"}, 0, 37));
		pokedex.add(new Pokemon("Avalugg", "Ice", null, 95, 117, 184, 44, 46, 28, 25, new String[] {"Monster"}, 50, new String[] {"Bergmite", "Avalugg"}, 1, 0));
		pokedex.add(new Pokemon("Noibat", "Flying", "Dragon", 40, 30, 35, 45, 40, 55, 6, new String[] {"Flying"}, 50, new String[] {"Noibat", "Noivern"}, 0, 48));
		pokedex.add(new Pokemon("Noivern", "Flying", "Dragon", 85, 70, 80, 97, 80, 123, 27, new String[] {"Flying"}, 50, new String[] {"Noibat", "Noivern"}, 1, 0));
		pokedex.add(new Pokemon("Xerneas", "Fairy", null, 126, 131, 95, 131, 98, 99, 27, new String[] {"Undiscovered"}, -1, new String[] {"Xerneas"}, 0, 0));
		pokedex.add(new Pokemon("Yveltal", "Dark", "Flying", 126, 131, 95, 131, 98, 99, 27, new String[] {"Undiscovered"}, -1, new String[] {"Yveltal"}, 0, 0));
		pokedex.add(new Pokemon("Zygarde10%", "Dragon", "Ground", 54, 100, 71, 61, 85, 115, 32, new String[] {"Undiscovered"}, -1, new String[] {"Zygarde10%"}, 0, 0)); // 744:718
		pokedex.add(new Pokemon("Zygarde50%", "Dragon", "Ground", 108, 100, 121, 81, 95, 95, 32, new String[] {"Undiscovered"}, -1, new String[] {"Zygarde50%"}, 0, 0)); // 745:718
		pokedex.add(new Pokemon("ZygardeC", "Dragon", "Ground", 216, 100, 121, 91, 95, 85, 32, new String[] {"Undiscovered"}, -1, new String[] {"ZygardeC"}, 0, 0)); // 746:718
		pokedex.add(new Pokemon("Diancie", "Rock", "Fairy", 50, 100, 150, 100, 150, 50, 32, new String[] {"Undiscovered"}, -1, new String[] {"Diancie"}, 0, 0));
		pokedex.add(new Pokemon("HoopaC", "Psychic", "Ghost", 80, 110, 60, 150, 130, 70, 32, new String[] {"Undiscovered"}, -1, new String[] {"HoopaC"}, 0, 0)); // 748:720
		pokedex.add(new Pokemon("HoopaU", "Psychic", "Dark", 80, 160, 60, 170, 130, 80, 32, new String[] {"Undiscovered"}, -1, new String[] {"HoopaU"}, 0, 0)); // 749:720
		pokedex.add(new Pokemon("Volcanion", "Fire", "Water", 80, 110, 120, 130, 90, 70, 32, new String[] {"Undiscovered"}, -1, new String[] {"Volcanion"}, 0, 0));
		pokedex.add(new Pokemon("Rowlet", "Grass", "Flying", 68, 55, 55, 50, 50, 42, 27, new String[] {"Flying"}, 87.5, new String[] {"Rowlet", "Dartrix", "Decidueye"}, 0, 17));
		pokedex.add(new Pokemon("Dartrix", "Grass", "Flying", 78, 75, 75, 70, 70, 52, 27, new String[] {"Flying"}, 87.5, new String[] {"Rowlet", "Dartrix", "Decidueye"}, 1, 34));
		pokedex.add(new Pokemon("Decidueye", "Grass", "Ghost", 78, 107, 75, 100, 100, 70, 27, new String[] {"Flying"}, 87.5, new String[] {"Rowlet", "Dartrix", "Decidueye"}, 2, 0));
		pokedex.add(new Pokemon("Litten", "Fire", null, 45, 65, 40, 60, 40, 70, 27, new String[] {"Field"}, 87.5, new String[] {"Litten", "Torracat", "Incineroar"}, 0, 17));
		pokedex.add(new Pokemon("Torracat", "Fire", null, 65, 85, 50, 80, 50, 90, 27, new String[] {"Field"}, 87.5, new String[] {"Litten", "Torracat", "Incineroar"}, 1, 34));
		pokedex.add(new Pokemon("Incineroar", "Fire", "Dark", 95, 115, 90, 80, 90, 60, 27, new String[] {"Field"}, 87.5, new String[] {"Litten", "Torracat", "Incineroar"}, 2, 0));
		pokedex.add(new Pokemon("Popplio", "Water", null, 50, 54, 54, 66, 56, 40, 27, new String[] {"Water 1", "Field"}, 87.5, new String[] {"Popplio", "Brionne", "Primarina"}, 0, 17));
		pokedex.add(new Pokemon("Brionne", "Water", null, 60, 69, 69, 91, 81, 50, 27, new String[] {"Water 1", "Field"}, 87.5, new String[] {"Popplio", "Brionne", "Primarina"}, 1, 34));
		pokedex.add(new Pokemon("Primarina", "Water", "Fairy", 80, 74, 74, 126, 116, 80, 27, new String[] {"Water 1", "Field"}, 87.5, new String[] {"Popplio", "Brionne", "Primarina"}, 2, 0));
		pokedex.add(new Pokemon("Pikipek", "Normal", "Flying", 35, 75, 30, 30, 30, 65, 0, new String[] {"Flying"}, 50, new String[] {"Pikipek", "Trumbeak", "Toucannon"}, 0, 14));
		pokedex.add(new Pokemon("Trumbeak", "Normal", "Flying", 55, 85, 50, 40, 50, 75, 17, new String[] {"Flying"}, 50, new String[] {"Pikipek", "Trumbeak", "Toucannon"}, 1, 28));
		pokedex.add(new Pokemon("Toucannon", "Normal", "Flying", 80, 120, 75, 75, 75, 60, 27, new String[] {"Flying"}, 50, new String[] {"Pikipek", "Trumbeak", "Toucannon"}, 2, 0));
		pokedex.add(new Pokemon("Yungoos", "Normal", null, 48, 70, 30, 30, 30, 45, 0, new String[] {"Field"}, 50, new String[] {"Yungoos", "Gumshoos"}, 0, 20));
		pokedex.add(new Pokemon("Gumshoos", "Normal", null, 88, 110, 60, 55, 60, 45, 15, new String[] {"Field"}, 50, new String[] {"Yungoos", "Gumshoos"}, 1, 0));
		pokedex.add(new Pokemon("Grubbin", "Bug", null, 47, 62, 45, 55, 45, 46, 0, new String[] {"Bug"}, 50, new String[] {"Grubbin", "Charjabug", "Vikavolt"}, 0, 20));
		pokedex.add(new Pokemon("Charjabug", "Bug", "Electric", 57, 82, 95, 55, 75, 36, 17, new String[] {"Bug"}, 50, new String[] {"Grubbin", "Charjabug", "Vikavolt"}, 1, -1));
		pokedex.add(new Pokemon("Vikavolt", "Bug", "Electric", 77, 70, 90, 145, 75, 43, 27, new String[] {"Bug"}, 50, new String[] {"Grubbin", "Charjabug", "Vikavolt"}, 2, 0));
		pokedex.add(new Pokemon("Crabrawler", "Fighting", null, 47, 82, 57, 42, 47, 63, 2, new String[] {"Water 3"}, 50, new String[] {"Crabrawler", "Crabominable"}, 0, -1));
		pokedex.add(new Pokemon("Crabominable", "Fighting", "Ice", 97, 132, 77, 62, 67, 43, 24, new String[] {"Water 3"}, 50, new String[] {"Crabrawler", "Crabominable"}, 1, 0));
		pokedex.add(new Pokemon("OricorioB", "Fire", "Flying", 75, 70, 70, 98, 70, 93, 27, new String[] {"Flying"}, 25, new String[] {"OricorioB"}, 0, 0)); // 770:741
		pokedex.add(new Pokemon("OricorioPP", "Electric", "Flying", 75, 70, 70, 98, 70, 93, 27, new String[] {"Flying"}, 25, new String[] {"OricorioPP"}, 0, 0)); // 771:741
		pokedex.add(new Pokemon("OricorioP", "Psychic", "Flying", 75, 70, 70, 98, 70, 93, 27, new String[] {"Flying"}, 25, new String[] {"OricorioP"}, 0, 0)); // 772:741
		pokedex.add(new Pokemon("OricorioS", "Ghost", "Flying", 75, 70, 70, 98, 70, 93, 27, new String[] {"Flying"}, 25, new String[] {"OricorioS"}, 0, 0)); // 773:741
		pokedex.add(new Pokemon("Cutiefly", "Bug", "Fairy", 40, 45, 40, 55, 40, 84, 6, new String[] {"Bug", "Fairy"}, 50, new String[] {"Cutiefly", "Ribombee"}, 0, 25));
		pokedex.add(new Pokemon("Ribombee", "Bug", "Fairy", 60, 55, 60, 95, 70, 124, 21, new String[] {"Bug", "Fairy"}, 50, new String[] {"Cutiefly", "Ribombee"}, 1, 0));
		pokedex.add(new Pokemon("Rockruff", "Rock", null, 45, 65, 40, 30, 40, 60, 6, new String[] {"Field"}, 50, new String[] {"Rockruff", "LycanrocMD"}, 0, 25));
		pokedex.add(new Pokemon("LycanrocMD", "Rock", null, 75, 115, 65, 55, 65, 112, 19, new String[] {"Field"}, 50, new String[] {"Rockruff", "LycanrocMD"}, 1, 0)); // 777:745
		pokedex.add(new Pokemon("LycanrocMN", "Rock", null, 85, 115, 75, 55, 75, 82, 19, new String[] {"Field"}, 50, new String[] {"Rockruff", "LycanrocMN"}, 1, 0)); // 778:745
		pokedex.add(new Pokemon("LycanrocD", "Rock", null, 75, 117, 65, 55, 65, 110, 19, new String[] {"Field"}, 50, new String[] {"Rockruff", "LycanrocD"}, 1, 0)); // 779:745
		pokedex.add(new Pokemon("WishiwashiSolo", "Water", null, 45, 20, 20, 25, 25, 40, 24, new String[] {"Water 2"}, 50, new String[] {"WishiwashiSolo"}, 0, 0)); // 780:746
		pokedex.add(new Pokemon("WishiwashiSchool", "Water", null, 45, 140, 130, 140, 135, 30, 24, new String[] {"Water 2"}, 50, new String[] {"WishiwashiSchool"}, 0, 0)); // 781:746
		pokedex.add(new Pokemon("Mareanie", "Poison", "Water", 50, 53, 62, 43, 52, 45, 6, new String[] {"Water 1"}, 50, new String[] {"Mareanie", "Toxapex"}, 0, 38));
		pokedex.add(new Pokemon("Toxapex", "Poison", "Water", 50, 63, 152, 53, 142, 35, 21, new String[] {"Water 1"}, 50, new String[] {"Mareanie", "Toxapex"}, 1, 0));
		pokedex.add(new Pokemon("Mudbray", "Ground", null, 70, 100, 70, 45, 55, 45, 6, new String[] {"Field"}, 50, new String[] {"Mudbray", "Mudsdale"}, 0, 30));
		pokedex.add(new Pokemon("Mudsdale", "Ground", null, 100, 125, 100, 55, 85, 35, 24, new String[] {"Field"}, 50, new String[] {"Mudbray", "Mudsdale"}, 1, 0));
		pokedex.add(new Pokemon("Dewpider", "Water", "Bug", 38, 40, 52, 40, 72, 27, 5, new String[] {"Water 1", "Bug"}, 50, new String[] {"Dewpider", "Araquanid"}, 0, 22));
		pokedex.add(new Pokemon("Araquanid", "Water", "Bug", 68, 70, 92, 50, 132, 42, 18, new String[] {"Water 1", "Bug"}, 50, new String[] {"Dewpider", "Araquanid"}, 1, 0));
		pokedex.add(new Pokemon("Fomantis", "Grass", null, 40, 55, 35, 50, 35, 35, 6, new String[] {"Grass"}, 50, new String[] {"Fomantis", "Lurantis"}, 0, 34));
		pokedex.add(new Pokemon("Lurantis", "Grass", null, 70, 105, 90, 80, 90, 45, 21, new String[] {"Grass"}, 50, new String[] {"Fomantis", "Lurantis"}, 1, 0));
		pokedex.add(new Pokemon("Morelull", "Grass", "Fairy", 40, 35, 55, 65, 75, 15, 6, new String[] {"Grass"}, 50, new String[] {"Morelull", "Shiinotic"}, 0, 24));
		pokedex.add(new Pokemon("Shiinotic", "Grass", "Fairy", 60, 45, 80, 90, 100, 30, 21, new String[] {"Grass"}, 50, new String[] {"Morelull", "Shiinotic"}, 1, 0));
		pokedex.add(new Pokemon("Salandit", "Poison", "Fire", 48, 44, 40, 71, 40, 77, 17, new String[] {"Monster", "Dragon"}, 87.5, new String[] {"Salandit", "Salazzle"}, 0, 33));
		pokedex.add(new Pokemon("Salazzle", "Poison", "Fire", 68, 64, 60, 111, 60, 117, 27, new String[] {"Monster", "Dragon"}, 87.5, new String[] {"Salandit", "Salazzle"}, 1, 0));
		pokedex.add(new Pokemon("Stufful", "Normal", "Fighting", 70, 75, 50, 45, 50, 50, 13, new String[] {"Field"}, 50, new String[] {"Stufful", "Bewear"}, 0, 27));
		pokedex.add(new Pokemon("Bewear", "Normal", "Fighting", 120, 125, 80, 55, 60, 60, 22, new String[] {"Field"}, 50, new String[] {"Stufful", "Bewear"}, 1, 0));
		pokedex.add(new Pokemon("Bounsweet", "Grass", null, 42, 30, 38, 30, 38, 32, 1, new String[] {"Grass"}, 0, new String[] {"Bounsweet", "Steenee", "Tsareena"}, 0, 18));
		pokedex.add(new Pokemon("Steenee", "Grass", null, 52, 40, 48, 40, 48, 62, 17, new String[] {"Grass"}, 0, new String[] {"Bounsweet", "Steenee", "Tsareena"}, 1, -1));
		pokedex.add(new Pokemon("Tsareena", "Grass", null, 72, 120, 98, 50, 98, 72, 27, new String[] {"Grass"}, 0, new String[] {"Bounsweet", "Steenee", "Tsareena"}, 2, 0));
		pokedex.add(new Pokemon("Comfey", "Fairy", null, 51, 52, 90, 82, 110, 100, 24, new String[] {"Grass"}, 25, new String[] {"Comfey"}, 0, 0));
		pokedex.add(new Pokemon("Oranguru", "Normal", "Psychic", 90, 60, 80, 90, 110, 60, 27, new String[] {"Field"}, 50, new String[] {"Oranguru"}, 0, 0));
		pokedex.add(new Pokemon("Passimian", "Fighting", null, 100, 120, 90, 40, 60, 80, 27, new String[] {"Field"}, 50, new String[] {"Passimian"}, 0, 0));
		pokedex.add(new Pokemon("Wimpod", "Bug", "Water", 25, 35, 40, 20, 30, 80, 19, new String[] {"Bug", "Water 3"}, 50, new String[] {"Wimpod", "Golisopod"}, 0, 30));
		pokedex.add(new Pokemon("Golisopod", "Bug", "Water", 75, 125, 140, 60, 90, 40, 27, new String[] {"Bug", "Water 3"}, 50, new String[] {"Wimpod", "Golisopod"}, 1, 0));
		pokedex.add(new Pokemon("Sandygast", "Ghost", "Ground", 55, 55, 80, 70, 45, 15, 13, new String[] {"Amorphous"}, 50, new String[] {"Sandygast", "Palossand"}, 0, 42));
		pokedex.add(new Pokemon("Palossand", "Ghost", "Ground", 85, 75, 110, 100, 75, 35, 24, new String[] {"Amorphous"}, 50, new String[] {"Sandygast", "Palossand"}, 1, 0));
		pokedex.add(new Pokemon("Pyukumuku", "Water", null, 55, 60, 130, 30, 130, 5, 24, new String[] {"Water 1"}, 50, new String[] {"Pyukumuku"}, 0, 0));
		pokedex.add(new Pokemon("Type: Null", "Normal", null, 95, 95, 95, 95, 95, 59, 32, new String[] {"Undiscovered"}, -1, new String[] {"Type: Null", "Silvally"}, 0, -1));
		pokedex.add(new Pokemon("Silvally", "Normal", null, 95, 95, 95, 95, 95, 95, 32, new String[] {"Undiscovered"}, -1, new String[] {"Type: Null", "Silvally"}, 1, 0));
		pokedex.add(new Pokemon("MiniorM", "Rock", "Flying", 60, 60, 100, 60, 100, 60, 29, new String[] {"Mineral"}, -1, new String[] {"MiniorM"}, 0, 0));
		pokedex.add(new Pokemon("MiniorC", "Rock", "Flying", 60, 100, 60, 100, 60, 120, 29, new String[] {"Mineral"}, -1, new String[] {"MiniorC"}, 0, 0));
		pokedex.add(new Pokemon("Komala", "Normal", null, 65, 115, 65, 75, 95, 65, 27, new String[] {"Field"}, 50, new String[] {"Komala"}, 0, 0));
		pokedex.add(new Pokemon("Turtonator", "Fire", "Dragon", 60, 78, 135, 91, 85, 36, 22, new String[] {"Monster", "Dragon"}, 50, new String[] {"Turtonator"}, 0, 0));
		pokedex.add(new Pokemon("Togedemaru", "Electric", "Steel", 65, 98, 63, 40, 73, 96, 7, new String[] {"Field", "Fairy"}, 50, new String[] {"Togedemaru"}, 0, 0));
		pokedex.add(new Pokemon("Mimikyu", "Ghost", "Fairy", 55, 90, 80, 50, 105, 96, 27, new String[] {"Amorphous"}, 50, new String[] {"Mimikyu"}, 0, 0));
		pokedex.add(new Pokemon("Bruxish", "Water", "Psychic", 68, 105, 70, 70, 70, 92, 20, new String[] {"Water 2"}, 50, new String[] {"Bruxish"}, 0, 0));
		pokedex.add(new Pokemon("Drampa", "Normal", "Dragon", 78, 60, 85, 135, 91, 36, 22, new String[] {"Monster", "Dragon"}, 50, new String[] {"Drampa"}, 0, 0));
		pokedex.add(new Pokemon("Dhelmise", "Ghost", "Grass", 70, 131, 100, 86, 90, 40, 30, new String[] {"Mineral"}, -1, new String[] {"Dhelmise"}, 0, 0));
		pokedex.add(new Pokemon("Jangmo-o", "Dragon", null, 45, 55, 65, 45, 45, 45, 27, new String[] {"Dragon"}, 50, new String[] {"Jangmo-o", "Hakamo-o", "Kommo-o"}, 0, 35));
		pokedex.add(new Pokemon("Hakamo-o", "Dragon", "Fighting", 55, 75, 90, 65, 70, 65, 27, new String[] {"Dragon"}, 50, new String[] {"Jangmo-o", "Hakamo-o", "Kommo-o"}, 1, 45));
		pokedex.add(new Pokemon("Kommo-o", "Dragon", "Fighting", 75, 110, 125, 100, 105, 85, 27, new String[] {"Dragon"}, 50, new String[] {"Jangmo-o", "Hakamo-o", "Kommo-o"}, 2, 0));
		pokedex.add(new Pokemon("Tapu Koko", "Electric", "Fairy", 70, 115, 85, 95, 75, 130, 32, new String[] {"Undiscovered"}, -1, new String[] {"Tapu Koko"}, 0, 0));
			...
			if (bred) {
				...
				if (oldOne.getName().equals("Latias") || oldOne.getName().equals("Latios")) {
					...
					if (oldOne.getName().equals("Heatran")) {
						...
						while (repeat) {
							System.out.println();
							System.out.println("Would you like your baby Pokemon to be a " + oldOne.getPokemon().getEvolutionTree()[0] + " or a " + oldTwo.getPokemon().getEvolutionTree()[0] + "?");
							System.out.println("Enter the number corresponding your choice or enter \"0\" to go back to the main menu.");
							System.out.println("1) " + oldOne.getPokemon().getEvolutionTree()[0]);
							System.out.println("2) " + oldTwo.getPokemon().getEvolutionTree()[0]);
							System.out.println();
							if (input.hasNext()) {
								switch (input.nextLine()) {
								case "1":
									for (Pokemon pok: pokedex)
										if (pok.getName().equals(oldOne.getPokemon().getEvolutionTree()[0])) {
								...
								case "2":
									for (Pokemon pok: pokedex)
										if (pok.getName().equals(oldTwo.getPokemon().getEvolutionTree()[0])) {
								...
								while (!repeat) {
									...
									if (input.hasNext())
										...
										case "8":
											System.out.println();
											p.spendTier4(100);
											poke = pokedex.get(720);
											op = new OwnedPokemon(p.getPC().get(num - 1), poke);
											p.getPC().remove(num - 1);
											p.catchPokemon(op);
											System.out.println("Congratulations, your Eevee has evolved into a Sylveon!");
											p.getPC().get(p.getIndex(op)).addT4PointsInvested(100);
											finished = true;
											repeat = true;
											break;
	...
	private static void changeForme(Player p, ArrayList<Pokemon> pokedex, Scanner input) {
		...
		for (OwnedPokemon op: p.getPC())
			if (op.getName().equals("DeoxysN") || op.getName().equals("DeoxysA") || op.getName().equals("DeoxysD") || op.getName().equals("DeoxysS")
					...
					|| op.getName().equals("TornadusI") || op.getName().equals("TornadusT")
					|| op.getName().equals("ThundurusI") || op.getName().equals("ThundurusT")
					|| op.getName().equals("LandorusI") || op.getName().equals("LandorusT")
					|| op.getName().equals("Kyurem") || op.getName().equals("KyuremW") || op.getName().equals("KyuremB")
					|| op.getName().equals("MeloettaA") || op.getName().equals("MeloettaP")
					|| op.getName().equals("Greninja") || op.getName().equals("GreninjaA")
					|| op.getName().equals("AegislashSh") || op.getName().equals("AegislashSw")
					|| op.getName().equals("OricorioB") || op.getName().equals("OricorioPP") || op.getName().equals("OricorioP") || op.getName().equals("OricorioS")
					|| op.getName().equals("LycanrocMD") || op.getName().equals("LycanrocMN") || op.getName().equals("LycanrocD"))
				opArr.add(op);
		if (opArr.size() == 0) {
			System.out.println();
						...
						if (num < 0 || num >= p.getPC().size() + 1) {
							...
							if (num != 0) {
								...
								if (p.getPC().get(num - 1).getName().equals("WormadamP") || p.getPC().get(num - 1).getName().equals("WormadamS") || p.getPC().get(num - 1).getName().equals("WormadamT")) {
									...
									if (enough) {
										System.out.println();
										System.out.println("Changing Darmanitan's forme costs 100 Tier 3 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										...
										System.out.println();
										System.out.println("Changing this Pokemon's Forme costs 100 Tier 3 Points");
										System.out.println("You do not have enough Tier 3 Points to change this Pokemon's forme");
										System.out.println();
										done = true;
									}
								} else if (p.getPC().get(num - 1).getName().equals("TornadusI") || p.getPC().get(num - 1).getName().equals("TornadusT")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier5() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Tornadus' forme costs 100 Tier 5 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) TornadusI");
										System.out.println("2) TornadusT");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("TornadusI")) {
														poke = pokedex.get(653);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Tornadus is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("TornadusT")) {
														poke = pokedex.get(654);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
								...
								} else if (p.getPC().get(num - 1).getName().equals("ThundurusI") || p.getPC().get(num - 1).getName().equals("ThundurusT")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier5() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Thundurus' forme costs 100 Tier 5 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) ThundurusI");
										System.out.println("2) ThundurusT");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("ThundurusI")) {
														poke = pokedex.get(655);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Thundurus is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("ThundurusT")) {
														poke = pokedex.get(656);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
								...
								} else if (p.getPC().get(num - 1).getName().equals("LandorusI") || p.getPC().get(num - 1).getName().equals("LandorusT")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier5() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Landorus' forme costs 100 Tier 5 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) LandorusI");
										System.out.println("2) LandorusT");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("LandorusI")) {
														poke = pokedex.get(659);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Landorus is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("LandorusT")) {
														poke = pokedex.get(660);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
								...
								} else if (p.getPC().get(num - 1).getName().equals("Kyurem") || p.getPC().get(num - 1).getName().equals("KyuremW") || p.getPC().get(num - 1).getName().equals("KyuremB")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier5() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Kyurem' forme costs 100 Tier 5 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) Kyurem");
										System.out.println("2) KyuremW");
										System.out.println("3) KyuremB");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("Kyurem")) {
														poke = pokedex.get(661);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Kyurem is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("KyuremW")) {
														poke = pokedex.get(662);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
													...
													break;
												case "3":
													if (!op.getName().equals("KyuremB")) {
														poke = pokedex.get(663);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
								...
								} else if (p.getPC().get(num - 1).getName().equals("MeloettaA") || p.getPC().get(num - 1).getName().equals("MeloettaP")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier5() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Meloetta's forme costs 100 Tier 5 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) MeloettaA");
										System.out.println("2) MeloettaP");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("MeloettaA")) {
														poke = pokedex.get(665);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Meloetta is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("MeloettaP")) {
														poke = pokedex.get(666);
														p.spendTier5(100);
														p.getPC().get(num - 1).addT5PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
								...
								} else if (p.getPC().get(num - 1).getName().equals("Greninja") || p.getPC().get(num - 1).getName().equals("GreninjaA")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier4() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Greninja's forme costs 100 Tier 4 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) Greninja");
										System.out.println("2) GreninjaA");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("Greninja")) {
														poke = pokedex.get(676);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Greninja is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("GreninjaA")) {
														poke = pokedex.get(677);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
										...
										System.out.println();
										System.out.println("Changing this Pokemon's Forme costs 100 Tier 4 Points");
										System.out.println("You do not have enough Tier 4 Points to change this Pokemon's forme");
										System.out.println();
										done = true;
									}
								} else if (p.getPC().get(num - 1).getName().equals("AegislashSh") || p.getPC().get(num - 1).getName().equals("AegislashSw")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier4() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Aegislash's forme costs 100 Tier 4 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) AegislashSh");
										System.out.println("2) AegislashSw");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("AegislashSh")) {
														poke = pokedex.get(700);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Aegislash is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("AegislashSw")) {
														poke = pokedex.get(701);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
								...
								} else if (p.getPC().get(num - 1).getName().equals("OricorioB") || p.getPC().get(num - 1).getName().equals("OricorioPP") || p.getPC().get(num - 1).getName().equals("OricorioP") || p.getPC().get(num - 1).getName().equals("OricorioS")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier4() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Oricorio's forme costs 100 Tier 4 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) OricorioB");
										System.out.println("2) OricorioPP");
										System.out.println("3) OricorioP");
										System.out.println("4) OricorioS");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("OricorioB")) {
														poke = pokedex.get(770);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Oricorio is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("OricorioPP")) {
														poke = pokedex.get(771);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
													...
													break;
												case "3":
													if (!op.getName().equals("OricorioP")) {
														poke = pokedex.get(772);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
													...
													break;
												case "4":
													if (!op.getName().equals("OricorioS")) {
														poke = pokedex.get(773);
														p.spendTier4(100);
														p.getPC().get(num - 1).addT4PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
								...
								} else if (p.getPC().get(num - 1).getName().equals("LycanrocMD") || p.getPC().get(num - 1).getName().equals("LycanrocMN") || p.getPC().get(num - 1).getName().equals("LycanrocD")) {
									num = p.getIndex(opArr.get(num - 1)) + 1;
									boolean enough = true;
									if (p.getTier3() < 100)
										enough = false;
									if (enough) {
										System.out.println();
										System.out.println("Changing Lycanroc's forme costs 100 Tier 3 Points");
										System.out.println("Which forme would you like this Pokemon to have?");
										System.out.println("1) LycanrocMD");
										System.out.println("2) LycanrocMN");
										System.out.println("3) LycanrocD");
										System.out.println("Enter \"0\" to go back to the main menu.");
										System.out.println();
										boolean finished = false;
										OwnedPokemon op = p.getPC().get(num - 1);
										...
										while (!finished)
											if (input.hasNext()) {
												switch(temp) {
												case "1":
													if (!op.getName().equals("LycanrocMD")) {
														poke = pokedex.get(777);
														p.spendTier3(100);
														p.getPC().get(num - 1).addT3PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
														...
														System.out.println();
														System.out.println("Lycanroc is already this forme.");
														System.out.println();
													}
													break;
												case "2":
													if (!op.getName().equals("LycanrocMN")) {
														poke = pokedex.get(778);
														p.spendTier3(100);
														p.getPC().get(num - 1).addT3PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
													...
													break;
												case "3":
													if (!op.getName().equals("LycanrocD")) {
														poke = pokedex.get(779);
														p.spendTier3(100);
														p.getPC().get(num - 1).addT3PointsInvested(100);
														op = p.getPC().get(num - 1);
														p.getPC().remove(num - 1);
