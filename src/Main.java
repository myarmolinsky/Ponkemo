...
//		p.addTier4(600);
	...
	private static void fillPossibilities(ArrayList<Pokemon> pokedex) {
		...
		pokedex.add(new Pokemon("Squirtle", "Water", null, 44, 48, 65, 50, 64, 43, 27, new String[] {"monster", "water1"}, 87.5, new String[] {"Squirtle", "Wartortle", "Blastoise"}, 0, 16));
		pokedex.add(new Pokemon("Wartortle", "Water", null, 59, 63, 80, 65, 80, 58, 27, new String[] {"monster", "water1"}, 87.5, new String[] {"Squirtle", "Wartortle", "Blastoise"}, 1, 36));
		pokedex.add(new Pokemon("Blastoise", "Water", null, 79, 83, 100, 85, 105, 78, 27, new String[] {"monster", "water1"}, 87.5, new String[] {"Squirtle", "Wartortle", "Blastoise"}, 2, 0));
		...
		pokedex.add(new Pokemon("Nidorina", "Poison", null, 70, 62, 67, 55, 55, 56, 17, new String[] {"monster", "water1"}, 0, new String[] {"NidoranF", "Nidorina", "Nidoqueen"}, 1, -1));
		pokedex.add(new Pokemon("Nidoqueen", "Poison", "Ground", 90, 82, 87, 75, 85, 76, 27, new String[] {"monster", "water1"}, 0, new String[] {"NidoranF", "Nidorina", "Nidoqueen"}, 2, 0));
		pokedex.add(new Pokemon("NidoranM", "Poison", null, 46, 57, 40, 40, 40, 50, 1, new String[] {"monster", "water1"}, 100, new String[] {"NidoranM", "Nidorino", "Nidoking"}, 0, 16));
		pokedex.add(new Pokemon("Nidorino", "Poison", null, 61, 72, 57, 55, 55, 65, 17, new String[] {"monster", "water1"}, 100, new String[] {"NidoranM", "Nidorino", "Nidoking"}, 1, -1));
		pokedex.add(new Pokemon("Nidoking", "Poison", "Ground", 81, 102, 77, 85, 75, 85, 27, new String[] {"monster", "water1"}, 100, new String[] {"NidoranM", "Nidorino", "Nidoking"}, 2, 0));
		...
		pokedex.add(new Pokemon("Psyduck", "Water", null, 50, 52, 48, 65, 50, 55, 6, new String[] {"field", "water1"}, 50, new String[] {"Psyduck", "Golduck"}, 0, 33));
		pokedex.add(new Pokemon("Golduck", "Water", null, 80, 82, 78, 95, 80, 85, 21, new String[] {"field", "water1"}, 50, new String[] {"Psyduck", "Golduck"}, 1, 0));
		...
		pokedex.add(new Pokemon("Poliwag", "Water", null, 40, 50, 40, 40, 40, 90, 0, new String[] {"water1"}, 50, new String[] {"Poliwag", "Poliwhirl", "Poliwrath"}, 0, 25));
		pokedex.add(new Pokemon("Poliwhirl", "Water", null, 65, 65, 65, 50, 50, 90, 17, new String[] {"water1"}, 50, new String[] {"Poliwag", "Poliwhirl", "Poliwrath"}, 1, -1));
		pokedex.add(new Pokemon("Poliwrath", "Water", "Fighting", 90, 95, 95, 70, 90, 70, 27, new String[] {"water1"}, 50, new String[] {"Poliwag", "Poliwhirl", "Poliwrath"}, 3, 0));
		...
		pokedex.add(new Pokemon("Tentacool", "Water", "Poison", 40, 40, 35, 50, 100, 70, 6, new String[] {"water3"}, 50, new String[] {"Tentacool", "Tentacruel"}, 0, 30));
		pokedex.add(new Pokemon("Tentacruel", "Water", "Poison", 80, 70, 65, 80, 120, 100, 24, new String[] {"water3"}, 50, new String[] {"Tentacool", "Tentacruel"}, 1, 0));
		...
		pokedex.add(new Pokemon("Slowpoke", "Water", "Psychic", 90, 65, 65, 40, 40, 15, 6, new String[] {"monster", "water1"}, 50, new String[] {"Slowpoke", "Slowbro"}, 0, 37));
		pokedex.add(new Pokemon("Slowbro", "Water", "Psychic", 95, 75, 110, 100, 80, 30, 21, new String[] {"monster", "water1"}, 50, new String[] {"Slowpoke", "Slowbro"}, 1, 0));
		...
		pokedex.add(new Pokemon("Seel", "Water", null, 65, 45, 55, 45, 70, 45, 6, new String[] {"field", "water1"}, 50, new String[] {"Seel", "Dewgong"}, 0, 34));
		pokedex.add(new Pokemon("Dewgong", "Water", "Ice", 90, 70, 80, 70, 95, 70, 21, new String[] {"field", "water1"}, 50, new String[] {"Seel", "Dewgong"}, 1, 0));
		...
		pokedex.add(new Pokemon("Shellder", "Water", null, 30, 65, 100, 45, 25, 40, 6, new String[] {"water3"}, 50, new String[] {"Shellder", "Cloyster"}, 0, -1));
		pokedex.add(new Pokemon("Cloyster", "Water", "Ice", 50, 95, 180, 85, 45, 70, 24, new String[] {"water3"}, 50, new String[] {"Shellder", "Cloyster"}, 0, 0));
		...
		pokedex.add(new Pokemon("Krabby", "Water", null, 30, 105, 90, 25, 25, 50, 2, new String[] {"water3"}, 50, new String[] {"Krabby", "Kingler"}, 0, 28));
		pokedex.add(new Pokemon("Kingler", "Water", null, 55, 130, 115, 50, 50, 75, 24, new String[] {"water3"}, 50, new String[] {"Krabby", "Kingler"}, 1, 0));
		...
		pokedex.add(new Pokemon("Horsea", "Water", null, 30, 40, 70, 70, 25, 60, 2, new String[] {"water1", "dragon"}, 50, new String[] {"Horsea", "Seadra"}, 0, 32));
		pokedex.add(new Pokemon("Seadra", "Water", null, 55, 65, 95, 95, 45, 85, 21, new String[] {"water1", "dragon"}, 50, new String[] {"Horsea", "Seadra"}, 1, 0));
		pokedex.add(new Pokemon("Goldeen", "Water", null, 45, 67, 60, 35, 50, 63, 2, new String[] {"water2"}, 50, new String[] {"Goldeen", "Seaking"}, 0, 33));
		pokedex.add(new Pokemon("Seaking", "Water", null, 80, 92, 65, 65, 80, 68, 24, new String[] {"water2"}, 50, new String[] {"Goldeen", "Seaking"}, 1, 0));
		pokedex.add(new Pokemon("Staryu", "Water", null, 30, 45, 55, 70, 55, 85, 2, new String[] {"water3"}, -1, new String[] {"Staryu", "Starmie"}, 0, -1));
		pokedex.add(new Pokemon("Starmie", "Water", "Psychic", 60, 75, 85, 100, 85, 115, 24, new String[] {"water3"}, -1, new String[] {"Staryu", "Starmie"}, 1, 0));
		...
		pokedex.add(new Pokemon("Magikarp", "Water", null, 20, 10, 55, 15, 20, 80, 0, new String[] {"water2", "dragon"}, 50, new String[] {"Magikarp", "Gyarados"}, 0, 20));
		pokedex.add(new Pokemon("Gyarados", "Water", "Flying", 95, 125, 79, 60, 100, 81, 27, new String[] {"water2", "dragon"}, 50, new String[] {"Magikarp", "Gyarados"}, 1, 0));
		pokedex.add(new Pokemon("Lapras", "Water", "Ice", 130, 85, 80, 85, 95, 60, 27, new String[] {"water1", "monster"}, 50, new String[] {"Lapras"}, 0, 0));
		...
		pokedex.add(new Pokemon("Omanyte", "Rock", "Water", 35, 40, 100, 90, 55, 35, 27, new String[] {"water1", "water3"}, 87.5, new String[] {"Omanyte", "Omastar"}, 0, 40));
		pokedex.add(new Pokemon("Omastar", "Rock", "Water", 70, 60, 125, 115, 70, 55, 27, new String[] {"water1", "water3"}, 87.5, new String[] {"Omanyte", "Omastar"}, 1, 0));
		pokedex.add(new Pokemon("Kabuto", "Rock", "Water", 30, 80, 90, 55, 45, 55, 27, new String[] {"water1", "water3"}, 87.5, new String[] {"Kabuto", "Kabutops"}, 0, 40));
		pokedex.add(new Pokemon("Kabutops", "Rock", "Water", 60, 115, 105, 65, 70, 80, 27, new String[] {"water1", "water3"}, 87.5, new String[] {"Kabuto", "Kabutops"}, 1, 0));
		...
		pokedex.add(new Pokemon("Dratini", "Dragon", null, 41, 64, 45, 50, 50, 50, 27, new String[] {"water1", "dragon"}, 50, new String[] {"Dratini", "Dragonair", "Dragonite"}, 0, 30));
		pokedex.add(new Pokemon("Dragonair", "Dragon", null, 61, 84, 65, 70, 70, 70, 27, new String[] {"water1", "dragon"}, 50, new String[] {"Dratini", "Dragonair", "Dragonite"}, 1, 55));
		pokedex.add(new Pokemon("Dragonite", "Dragon", "Flying", 91, 134, 95, 100, 100, 80, 27, new String[] {"water1", "dragon"}, 50, new String[] {"Dratini", "Dragonair", "Dragonite"}, 2, 0));
