...
class Pokemon extends Component {
    ...
    render() {
        var poke = Pokemon.makePokemon("Bulbasaur", "Grass", "Poison", 45, 49, 49, 65, 65, 45, 27, ["Monster", "Grass"], 87.5, ["Bulbasaur", "Ivysaur", "Venusaur"], 0, 16)
        console.log(poke)

        return { makeOP: this.makeOwnedPokemon(), makePD: this.makePokedex(), makePM: this.makePokemon() }
    }
}
